...
class ControlChannelListener:
    def __init__(self, aggregator: ad.Aggregator, command_map: Dict[ad.ControlCommand, Callable[[ad.ControlMessage], None]]):
            ...
            async with client_session.ws_connect(self.url) as ws:
                async for message in ws:
                    ...
                    try:                
                        ...
                        logger.error("Received malformed control command; skipping: %s", message.data)
                        continue
